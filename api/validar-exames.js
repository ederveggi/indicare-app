...
// ── SYSTEM PROMPT (declarado antes do handler) ────────────────────────────────
...
export default async function handler(req, res) {
  ...
  const { paciente, indicacaoClinica, procedimentos, historico } = req.body || {};
...
${historico?.length > 0 ? 'Considere o histórico para avaliar repetição desnecessária de exames recentes.' : ''}
